...
Route::middleware(['auth'])->group(function () {
    // Estudiante solo puede ver el dashboard
    Route::middleware('role:estudiante,profesor,administrador,superadmin')->group(function () {
    ...
    // Todos los demás accesos excepto estudiantes
    Route::middleware('role:profesor,administrador,superadmin')->group(function () {
