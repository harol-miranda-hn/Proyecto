    ...
    <div class="container py-4">
        ...
        <div class="bg-warning bg-gradient text-white rounded-3 p-3 mb-4 d-flex flex-wrap align-items-start gap-3">
            ...
            <div class="flex-grow-1">
                <h2 class="h6 mb-1">Editar Alumno</h2>
        ...
        <div class="bg-white rounded-3 shadow-sm p-4">
            <form action="{{ route('alumnos.update', $alumno->id) }}" method="POST" id="studentForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nombre_completo" name="nombre_completo"
                                   value="{{ old('nombre_completo', $alumno->nombre_completo) }}" placeholder="Ej: Juan Carlos Pérez López">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="email" id="email" name="email" class="form-control"
                                       value="{{ old('email', $alumno->email) }}" placeholder="Ej: alumno@instituto.edu">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="numero_identidad" name="numero_identidad"
                                       maxlength="13" value="{{ old('numero_identidad', $alumno->numero_identidad) }}" placeholder="Ej: 0801199901234">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="telefono" name="telefono"
                                       maxlength="8" value="{{ old('telefono', $alumno->telefono) }}" placeholder="Ej: 99998888">
                ...
                <textarea class="form-control" id="direccion" name="direccion" rows="3"
                          placeholder="Ingrese la dirección completa">{{ old('direccion', $alumno->direccion) }}</textarea>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="encargado_nombre" name="encargado_nombre"
                                   value="{{ old('encargado_nombre', $alumno->encargado_nombre) }}" placeholder="Ej: María López">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="encargado_telefono" name="encargado_telefono"
                                       maxlength="8" value="{{ old('encargado_telefono', $alumno->encargado_telefono) }}" placeholder="Ej: 88887777">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <select class="form-select" id="parentesco" name="parentesco">
                                    <option value="">Seleccione...</option>
                                    <option value="madre" {{ old('parentesco', $alumno->parentesco) == 'madre' ? 'selected' : '' }}>Madre</option>
                                    <option value="padre" {{ old('parentesco', $alumno->parentesco) == 'padre' ? 'selected' : '' }}>Padre</option>
                                    <option value="tutor" {{ old('parentesco', $alumno->parentesco) == 'tutor' ? 'selected' : '' }}>Tutor</option>
                                    <option value="otro" {{ old('parentesco', $alumno->parentesco) == 'otro' ? 'selected' : '' }}>Otro</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                <textarea class="form-control" id="descripcion_enfermedad" name="descripcion_enfermedad" rows="3"
                          placeholder="Detalles de enfermedades, alergias o condiciones médicas...">{{ old('descripcion_enfermedad', $alumno->descripcion_enfermedad) }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                <textarea class="form-control" id="descripcion_observacion" name="descripcion_observacion" rows="3"
                          placeholder="Observaciones conductuales o académicas...">{{ old('descripcion_observacion', $alumno->descripcion_observacion) }}</textarea>
