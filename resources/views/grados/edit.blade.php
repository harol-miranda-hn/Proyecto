    ...
    <div class="container py-4">
        ...
        <div class="bg-warning bg-gradient text-white rounded-3 p-3 mb-4 d-flex flex-wrap align-items-start gap-3">
            ...
            <div class="flex-grow-1">
                <h2 class="h6 mb-1">Editar Grado</h2>
        ...
        <div class="bg-white rounded-3 shadow-sm p-4">
            <form action="{{ route('grados.update', $grado->id) }}" method="POST" id="gradoForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="curso" name="curso"
                                   value="{{ old('curso', $grado->curso) }}" placeholder="Ej: 1° de Bachillerato en Ciencias">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="modalidad" name="modalidad"
                                   value="{{ old('modalidad', $grado->modalidad) }}" placeholder="Ej: Humanidades, Técnico...">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="jornada" name="jornada">
                                ...
                                @foreach(['Matutina', 'Vespertina', 'Nocturna', 'ISEMED'] as $jornada)
                                    <option value="{{ $jornada }}" {{ old('jornada', $grado->jornada) == $jornada ? 'selected' : '' }}>{{ $jornada }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="seccion" name="seccion">
                                ...
                                @foreach(['A', 'B', 'C', 'D', 'E', 'F', 'G'] as $seccion)
                                    <option value="{{ $seccion }}" {{ old('seccion', $grado->seccion) == $seccion ? 'selected' : '' }}>{{ $seccion }}</option>
                                @endforeach
                            </select>
                ...
                <input type="hidden" name="matricula" value="{{ $grado->matricula ?? 0 }}">
