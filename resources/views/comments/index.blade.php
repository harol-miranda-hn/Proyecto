            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle text-center table-sm">
                    ...
                    @forelse ($comments as $index => $comment)
                        <tr>
                            <td class="text-start fw-semibold">{{ $comments->firstItem() + $index }}</td>
                            <td class="text-start fw-semibold">{{ $comment->user->name }}</td>
                            <td class="text-start">{{ Str::limit($comment->content, 80) }}</td>
                            <td class="text-start">{{ $comment->project->name }}</td>
                            <td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted">No se encontraron comentarios registrados.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
