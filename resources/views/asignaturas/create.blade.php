    ...
    <div class="container py-4">
        ...
        <div class="bg-primary bg-gradient text-white rounded-3 p-3 mb-4 d-flex align-items-start gap-3">
            ...
            <div class="flex-grow-1">
                <h2 class="h6 mb-1">Registrar Asignatura</h2>
                <p class="mb-0 small">Complete el siguiente campo para registrar una nueva asignatura</p>
            </div>
        </div>
            ...
            <form action="{{ route('asignaturas.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control"
                           value="{{ old('nombre') }}" placeholder="Ej: Matemáticas">
